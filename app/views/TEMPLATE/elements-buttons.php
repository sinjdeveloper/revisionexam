                ...
                <div class="sidebar-content">
                    <nav class="sidebar-nav">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="/TEMPLATE/dashboard"><i class="bi bi-speedometer2"></i><span>Dashboard</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/TEMPLATE/analytics"><i class="bi bi-graph-up"></i><span>Analytics</span></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse show" id="elementsSubmenu">
                                    <ul class="nav nav-submenu">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="/TEMPLATE/elements/buttons">
