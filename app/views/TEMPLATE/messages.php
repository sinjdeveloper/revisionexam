...
<head>
    ...
    <script nonce="<?php echo $nonce ?? ''; ?>">
        // Minimal fallback so Alpine's x-data="searchComponent" never fails.
        window.searchComponent = window.searchComponent || function() {
            return {
                query: '',
                results: [],
                search() { /* no-op fallback — implement real search in messages JS */ },
            };
        };
    </script>
  ...
  <script type="module" crossorigin nonce="<?php echo $nonce ?? ''; ?>" src="/assets/messages-ByGNYy7N.js"></script>
                ...
                <div class="sidebar-content">
                    <nav class="sidebar-nav">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="/TEMPLATE/messages">
